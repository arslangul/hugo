describe('hugo', function() {
    ...
    it('Section2', function () {
        browser.sleep(1000);
        var text=browser.driver.findElement(By.xpath('//md-radio-button[starts-with(@id,"radio_")][2]')).getText();
        text.then(
            function(output){
              //  console.log(output);
                expect(output).toContain('I want to conduct health care research as part of an organization');
            }
        );
        browser.driver.findElement(By.xpath('//md-radio-button[starts-with(@id,"radio_")][2]')).click();
